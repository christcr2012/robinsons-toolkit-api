 ...
 */
export function generatePropertyTests(config: PropertyTestConfig) {
 ...
 */
function detectProperties(domain, signature) {
 ...
 */
function generateTestPath(config: PropertyTestConfig){
 ...
 */
function generateFastCheckTests(config: PropertyTestConfig, properties){
  const imports = `import * from 'fast-check';
 ...
 */
function generateFastCheckProperty(config: PropertyTestConfig, property){
  switch (property) {
    case 'idempotence':
 ...
 */
function generateHypothesisTests(config: PropertyTestConfig, properties){
  const imports = `from hypothesis import given, strategies
import pytest
 ...
 */
function generateHypothesisProperty(config: PropertyTestConfig, property){
  switch (property) {
    case 'idempotence':
 ...
 */
export async function suggestPropertyTests(root) {
  const suggestions = [];
 ...
 */
function extractPureFunctions(content, filePath) {
  const configs = [];
 ...
 */
function detectDomain(functionName): PropertyTestConfig['domain'] {
