...
// ============================================================
export async function twilioMakeCall(args) {
...
export async function twilioGetCall(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { callSid } = args;
...
export async function twilioListCalls(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioUpdateCall(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioDeleteCall(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { callSid } = args;
...
export async function twilioCreateConference(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioGetConference(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioListConferences(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioUpdateConference(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioListConferenceParticipants(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { conferenceSid } = args;
...
export async function twilioGetConferenceParticipant(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioUpdateConferenceParticipant(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioRemoveConferenceParticipant(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { conferenceSid, callSid } = args;
...
export async function twilioGetRecording(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioListRecordings(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioDeleteRecording(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { recordingSid } = args;
...
export async function twilioGetTranscription(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioListTranscriptions(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioDeleteTranscription(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { transcriptionSid } = args;
...
// ============================================================
export async function twilioSearchAvailableNumbers(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioBuyPhoneNumber(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioGetPhoneNumber(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioListPhoneNumbers(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioUpdatePhoneNumber(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioDeletePhoneNumber(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { phoneNumberSid } = args;
