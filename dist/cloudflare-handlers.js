...
// ZONES (DNS & Domain Management) - 30 handlers
// ============================================================
export async function cloudflareListZones(args) {
...
export async function cloudflareGetZone(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { zoneId } = args;
...
export async function cloudflareCreateZone(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteZone(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { zoneId } = args;
...
export async function cloudflarePurgeCache(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareListDnsRecords(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareGetDnsRecord(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareCreateDnsRecord(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareUpdateDnsRecord(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteDnsRecord(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { zoneId, recordId } = args;
...
export async function cloudflareGetZoneSettings(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { zoneId } = args;
...
export async function cloudflareUpdateZoneSetting(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareGetSslSetting(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { zoneId } = args;
...
export async function cloudflareUpdateSslSetting(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareListFirewallRules(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareCreateFirewallRule(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareUpdateFirewallRule(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteFirewallRule(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareListPageRules(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { zoneId } = args;
...
export async function cloudflareCreatePageRule(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareUpdatePageRule(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeletePageRule(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { zoneId, ruleId } = args;
