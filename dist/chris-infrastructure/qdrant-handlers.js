...
// ============================================================================
export async function handleQdrantCollectionCreate(args) {
...
export async function handleQdrantCollectionList(args) {
    return await fastAPIClient.qdrantListCollections();
}
export async function handleQdrantCollectionGet(args) {
    const { collection_name } = args;
    return await fastAPIClient.qdrantGetCollection(collection_name);
}
export async function handleQdrantCollectionDelete(args) {
    const { collection_name } = args;
    return await fastAPIClient.qdrantDeleteCollection(collection_name);
}
export async function handleQdrantCollectionUpdate(args) {
...
// Search Operations
// ============================================================================
export async function handleQdrantSearchSemantic(args) {
    const { collection_name, query_vector, limit = 5, score_threshold, filter } = args;
    return await fastAPIClient.qdrantSearch(collection_name, query_vector, limit, score_threshold);
}
export async function handleQdrantSearchBatch(args) {
...
// Point Operations
// ============================================================================
export async function handleQdrantPointUpsert(args) {
...
export async function handleQdrantPointSearch(args) {
...
export async function handleQdrantPointsBatchUpsert(args) {
...
// Snapshot & Admin
// ============================================================================
export async function handleQdrantSnapshotCreate(args) {
    const { collection_name } = args;
    return await fastAPIClient.request(`/qdrant/collections/${collection_name}/snapshots`, {
        method: 'POST',
    });
}
export async function handleQdrantSnapshotList(args) {
    const { collection_name } = args;
    return await fastAPIClient.request(`/qdrant/collections/${collection_name}/snapshots`, {
        method: 'GET',
    });
}
export async function handleQdrantConnectionTest(args) {
    try {
