...
export class ToolRegistry {
    ...
    static GOOGLE_WORKSPACE_PREFIXES = [
     ...
     */
    getToolSchema(category, toolName) {
        const tools = this.toolsByCategory.get(category);
        if (!tools)
            return undefined;
     ...
     */
    listToolsInSubcategory(category, subcategory) {
        const tools = this.toolsByCategory.get(category);
        if (!tools)
            return [];
