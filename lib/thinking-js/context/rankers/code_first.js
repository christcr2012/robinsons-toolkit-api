 ...
 */
export function deriveHints(q): QueryHints {
...
function presenceOfSignature(methods, text) {
...
function classOrIfaceHint(name: string|undefined, text) {
  if (!name) return 0;
 ...
 */
function proximityBoost(queryTerms, text){
