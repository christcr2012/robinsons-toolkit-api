...
exports.context7ResolveLibraryId = context7ResolveLibraryId;
exports.context7SearchLibraries = context7SearchLibraries;
exports.context7ListLibraries = context7ListLibraries;
exports.context7GetLibraryDocs = context7GetLibraryDocs;
exports.context7SearchDocs = context7SearchDocs;
exports.context7GetApiReference = context7GetApiReference;
exports.context7GetGuides = context7GetGuides;
exports.context7CompareVersions = context7CompareVersions;
exports.context7GetMigrationGuide = context7GetMigrationGuide;
exports.context7ListVersions = context7ListVersions;
exports.context7GetExamples = context7GetExamples;
exports.context7SearchExamples = context7SearchExamples;
// Helper function to format Context7 responses
function formatContext7Response(result) {
    return { content: [{ type: 'text', text: JSON.stringify(result, null, 2) }] };
}
// ============================================================
// LIBRARY SEARCH - 3 handlers
// ============================================================
async function context7ResolveLibraryId(args) {
...
async function context7SearchLibraries(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
...
async function context7ListLibraries(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
...
// ============================================================
async function context7GetLibraryDocs(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
...
async function context7SearchDocs(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
...
async function context7GetApiReference(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
        const { library, version } = args;
...
async function context7GetGuides(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
        const { library, version } = args;
...
// ============================================================
async function context7CompareVersions(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
...
async function context7GetMigrationGuide(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
        const { library, from, to } = args;
...
async function context7ListVersions(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
        const { library } = args;
...
// EXAMPLES - 2 handlers
// ============================================================
async function context7GetExamples(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
...
async function context7SearchExamples(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
