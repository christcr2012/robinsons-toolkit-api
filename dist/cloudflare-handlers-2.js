...
// ============================================================
export async function cloudflareGetAnalytics(args) {
...
export async function cloudflareGetZonePlan(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { zoneId } = args;
...
export async function cloudflareListRateLimits(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareCreateRateLimit(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteRateLimit(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareListLoadBalancers(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { zoneId } = args;
...
export async function cloudflareCreateLoadBalancer(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteLoadBalancer(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
// WORKERS (25 handlers)
// ============================================================
export async function cloudflareListWorkers(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareGetWorker(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareUploadWorker(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteWorker(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { scriptName } = args;
...
export async function cloudflareListWorkerRoutes(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { zoneId } = args;
...
export async function cloudflareCreateWorkerRoute(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareUpdateWorkerRoute(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteWorkerRoute(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { routeId } = args;
...
export async function cloudflareListWorkerCronTriggers(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { scriptName } = args;
...
export async function cloudflareCreateWorkerCronTrigger(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteWorkerCronTrigger(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { scriptName, cron } = args;
...
export async function cloudflareGetWorkerSettings(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { scriptName } = args;
...
export async function cloudflareUpdateWorkerSettings(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareListWorkerSubdomain(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareCreateWorkerSubdomain(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareGetWorkerTail(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { scriptName } = args;
...
export async function cloudflareListWorkerSecrets(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { scriptName } = args;
...
export async function cloudflareCreateWorkerSecret(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteWorkerSecret(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
