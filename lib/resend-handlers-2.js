...
exports.resendUpdateContact = resendUpdateContact;
exports.resendDeleteContact = resendDeleteContact;
exports.resendImportContacts = resendImportContacts;
exports.resendExportContacts = resendExportContacts;
exports.resendUnsubscribeContact = resendUnsubscribeContact;
exports.resendResubscribeContact = resendResubscribeContact;
exports.resendSearchContacts = resendSearchContacts;
exports.resendListAudiences = resendListAudiences;
exports.resendGetAudience = resendGetAudience;
exports.resendCreateAudience = resendCreateAudience;
exports.resendDeleteAudience = resendDeleteAudience;
exports.resendGetAudienceStats = resendGetAudienceStats;
...
// ============================================================
async function resendListContacts(args) {
...
async function resendGetContact(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
async function resendCreateContact(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
async function resendUpdateContact(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
async function resendDeleteContact(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { contactId } = args;
...
async function resendImportContacts(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
async function resendExportContacts(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
async function resendUnsubscribeContact(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { contactId } = args;
...
async function resendResubscribeContact(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { contactId } = args;
...
async function resendSearchContacts(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
// ============================================================
async function resendListAudiences(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
async function resendGetAudience(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { audienceId } = args;
...
async function resendCreateAudience(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { name } = args;
...
async function resendDeleteAudience(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { audienceId } = args;
...
async function resendGetAudienceStats(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { audienceId } = args;
