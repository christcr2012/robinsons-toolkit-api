...
exports.BROKER_TOOLS = void 0;
exports.generateBrokerTools = generateBrokerTools;
/**
 * Generate broker tools with dynamic category enums
 * @param categories - Array of category names from the registry
 */
function generateBrokerTools(categories) {
 ...
 */
exports.BROKER_TOOLS = generateBrokerTools([]);
