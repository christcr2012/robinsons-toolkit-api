...
exports.handleNeo4jQueryExecute = handleNeo4jQueryExecute;
exports.handleNeo4jKnowledgeGraphCreateNode = handleNeo4jKnowledgeGraphCreateNode;
exports.handleNeo4jKnowledgeGraphCreateRelationship = handleNeo4jKnowledgeGraphCreateRelationship;
exports.handleNeo4jKnowledgeGraphQuery = handleNeo4jKnowledgeGraphQuery;
exports.handleNeo4jNodeCreate = handleNeo4jNodeCreate;
exports.handleNeo4jNodeGet = handleNeo4jNodeGet;
exports.handleNeo4jNodeUpdate = handleNeo4jNodeUpdate;
exports.handleNeo4jNodeDelete = handleNeo4jNodeDelete;
exports.handleNeo4jNodeSearch = handleNeo4jNodeSearch;
exports.handleNeo4jRelationshipCreate = handleNeo4jRelationshipCreate;
exports.handleNeo4jRelationshipGet = handleNeo4jRelationshipGet;
exports.handleNeo4jRelationshipDelete = handleNeo4jRelationshipDelete;
exports.handleNeo4jRelationshipSearch = handleNeo4jRelationshipSearch;
exports.handleNeo4jPatternMatch = handleNeo4jPatternMatch;
exports.handleNeo4jPathFind = handleNeo4jPathFind;
exports.handleNeo4jSchemaGet = handleNeo4jSchemaGet;
exports.handleNeo4jStatsGet = handleNeo4jStatsGet;
exports.handleNeo4jConnectionTest = handleNeo4jConnectionTest;
exports.handleNeo4jDatabaseList = handleNeo4jDatabaseList;
exports.handleNeo4jConstraintCreate = handleNeo4jConstraintCreate;
const fastapi_client_js_1 = require("./fastapi-client.js");
// ============================================================================
// Query Execution
// ============================================================================
async function handleNeo4jQueryExecute(args) {
    const { cypher, params } = args;
    return await fastapi_client_js_1.fastAPIClient.neo4jQuery(cypher, params);
}
// ============================================================================
// Knowledge Graph Operations
// ============================================================================
async function handleNeo4jKnowledgeGraphCreateNode(args) {
    ...
    RETURN n
  `;
    return await fastapi_client_js_1.fastAPIClient.neo4jQuery(cypher, properties);
}
async function handleNeo4jKnowledgeGraphCreateRelationship(args) {
...
async function handleNeo4jKnowledgeGraphQuery(args) {
    ...
    return await fastapi_client_js_1.fastAPIClient.neo4jQuery(cypher);
}
// ============================================================================
// Node Operations
// ============================================================================
async function handleNeo4jNodeCreate(args) {
    const { label, properties } = args;
...
async function handleNeo4jNodeGet(args) {
    const { node_id } = args;
    const cypher = `MATCH (n) WHERE id(n) = $node_id RETURN n`;
    return await fastapi_client_js_1.fastAPIClient.neo4jQuery(cypher, { node_id: parseInt(node_id) });
}
async function handleNeo4jNodeUpdate(args) {
    ...
    RETURN n
  `;
    return await fastapi_client_js_1.fastAPIClient.neo4jQuery(cypher, { node_id: parseInt(node_id), ...properties });
}
async function handleNeo4jNodeDelete(args) {
...
async function handleNeo4jNodeSearch(args) {
...
// ============================================================================
async function handleNeo4jRelationshipCreate(args) {
...
async function handleNeo4jRelationshipGet(args) {
    const { relationship_id } = args;
    const cypher = `MATCH ()-[r]->() WHERE id(r) = $relationship_id RETURN r`;
    return await fastapi_client_js_1.fastAPIClient.neo4jQuery(cypher, { relationship_id: parseInt(relationship_id) });
}
async function handleNeo4jRelationshipDelete(args) {
    const { relationship_id } = args;
    const cypher = `MATCH ()-[r]->() WHERE id(r) = $relationship_id DELETE r`;
    return await fastapi_client_js_1.fastAPIClient.neo4jQuery(cypher, { relationship_id: parseInt(relationship_id) });
}
async function handleNeo4jRelationshipSearch(args) {
...
// Pattern Matching
// ============================================================================
async function handleNeo4jPatternMatch(args) {
...
async function handleNeo4jPathFind(args) {
...
// Schema & Admin
// ============================================================================
async function handleNeo4jSchemaGet(args) {
    const cypher = 'CALL db.schema.visualization()';
    return await fastapi_client_js_1.fastAPIClient.neo4jQuery(cypher);
}
async function handleNeo4jStatsGet(args) {
    const cypher = `
    MATCH (n)
...
async function handleNeo4jConnectionTest(args) {
    try {
        const result = await fastapi_client_js_1.fastAPIClient.neo4jGetLabels();
        return {
            success: true,
...
async function handleNeo4jDatabaseList(args) {
    const cypher = 'SHOW DATABASES';
    return await fastapi_client_js_1.fastAPIClient.neo4jQuery(cypher);
}
async function handleNeo4jConstraintCreate(args) {
