...
class GitHubMCP {
    ...
    constructor(token) {
        this.server = new index_js_1.Server({ name: '@robinsonai/github-mcp', version: '2.0.0' }, { capabilities: { tools: {} } });
        this.token = token;
        this.setupHandlers();
    }
    ...
    client = {
        ...
        post: (path, body) => this.fetch(path, { method: 'POST', body: body ? JSON.stringify(body) : undefined }),
        patch: (path, body) => this.fetch(path, { method: 'PATCH', body: body ? JSON.stringify(body) : undefined }),
        put: (path, body) => this.fetch(path, { method: 'PUT', body: body ? JSON.stringify(body) : undefined }),
        delete: (path) => this.fetch(path, { method: 'DELETE' }),
    };
    setupHandlers() {
    ...
    async createRepo(args) {
        ...
        if (args.auto_init !== undefined)
            body.auto_init = args.auto_init;
        if (args.gitignore_template)
            body.gitignore_template = args.gitignore_template;
        if (args.license_template)
    ...
    async updateRepo(args) {
        ...
        if (args.has_issues !== undefined)
            body.has_issues = args.has_issues;
        if (args.has_projects !== undefined)
            body.has_projects = args.has_projects;
        if (args.has_wiki !== undefined)
            body.has_wiki = args.has_wiki;
    ...
    async disableAutomatedSecurityFixes(args) {
    ...
    async enableVulnerabilityAlerts(args) {
    ...
    async disableVulnerabilityAlerts(args) {
    ...
    async updateBranchProtection(args) {
        const body = {};
    ...
    async deleteBranchProtection(args) {
    ...
    async updatePullRequestReviewEnforcement(args) {
        const body = {};
        if (args.dismissal_restrictions)
            body.dismissal_restrictions = args.dismissal_restrictions;
        if (args.dismiss_stale_reviews !== undefined)
            body.dismiss_stale_reviews = args.dismiss_stale_reviews;
        if (args.require_code_owner_reviews !== undefined)
            body.require_code_owner_reviews = args.require_code_owner_reviews;
        if (args.required_approving_review_count)
            body.required_approving_review_count = args.required_approving_review_count;
    ...
    async createCommitComment(args) {
    ...
    async getCommitSignatureVerification(args) {
        const response = await this.client.get(`/repos/${args.owner}/${args.repo}/commits/${args.ref}`);
    ...
    async submitPullRequestReview(args) {
        const body = { event: args.event };
        if (args.body)
            body.body = args.body;
    ...
    async dismissPullRequestReview(args) {
    ...
    async createPullRequestReviewComment(args) {
    ...
    async removePullRequestReviewers(args) {
        const body = {};
        if (args.reviewers)
            body.reviewers = args.reviewers;
        if (args.team_reviewers)
    ...
    async updatePullRequestBranch(args) {
        const body = {};
    ...
    async getPullRequestPatch(args) {
    ...
    async convertIssueToPullRequest(args) {
    ...
    async listWorkflowRunArtifacts(args) {
        const params = {};
        if (args.per_page)
            params.per_page = args.per_page;
        if (args.page)
    ...
    async downloadWorkflowRunLogs(args) {
    ...
    async deleteWorkflowRunLogs(args) {
    ...
    async listWorkflowRunJobs(args) {
        const params = {};
        if (args.filter)
    ...
    async createOrUpdateRepoSecret(args) {
    ...
    async generateReleaseNotes(args) {
        ...
        if (args.target_commitish)
            body.target_commitish = args.target_commitish;
        if (args.previous_tag_name)
            body.previous_tag_name = args.previous_tag_name;
    ...
    async listRepoContributors(args) {
        const params = {};
        if (args.anon)
            params.anon = args.anon;
        if (args.per_page)
            params.per_page = args.per_page;
        if (args.page)
            params.page = args.page;
    ...
    async updateAuthenticatedUser(args) {
        const body = {};
        if (args.name)
            body.name = args.name;
        if (args.email)
    ...
    async createRepoSecretHandler(args) {
    ...
    async restorePackageVersion(args) {
    ...
    async updateSecretScanningAlert(args) {
...
class VercelMCP {
    ...
    // ==================== HELPER METHODS ====================
    async vercelFetch(endpoint, options = {}) {
    ...
    async listProjects(args) {
        ...
        if (args.teamId)
            params.append("teamId", args.teamId);
    ...
    async listDeployments(args) {
        ...
        const data = await this.vercelFetch(`/v6/deployments?projectId=${args.projectId}&${params}`);
        return this.formatResponse(data);
    }
    ...
    async cancelDeployment(args) {
        const data = await this.vercelFetch(`/v12/deployments/${args.deploymentId}/cancel`, { method: "PATCH" });
        return this.formatResponse(data);
    }
    ...
    async getDeploymentEvents(args) {
        const data = await this.vercelFetch(`/v3/deployments/${args.deploymentId}/events`);
        return this.formatResponse(data);
    }
    async redeploy(args) {
        const data = await this.vercelFetch(`/v13/deployments/${args.deploymentId}/redeploy`, {
            method: "POST",
    ...
    async deleteEnvVar(args) {
        const data = await this.vercelFetch(`/v9/projects/${args.projectId}/env/${args.envId}`, { method: "DELETE" });
        return this.formatResponse(data);
    }
    async bulkCreateEnvVars(args) {
    ...
    async deleteDnsRecord(args) {
        const data = await this.vercelFetch(`/v2/domains/${args.domain}/records/${args.recordId}`, { method: "DELETE" });
        return this.formatResponse(data);
    }
    // ==================== TEAM METHODS ====================
    ...
    async getDeploymentLogs(args) {
        ...
        if (args.limit)
            params.append("limit", args.limit.toString());
        if (args.since)
            params.append("since", args.since.toString());
    ...
    async getProjectAnalytics(args) {
        const params = new URLSearchParams();
        if (args.from)
            params.append("from", args.from.toString());
        if (args.to)
            params.append("to", args.to.toString());
        const data = await this.vercelFetch(`/v1/projects/${args.projectId}/analytics?${params}`);
        return this.formatResponse(data);
    }
    // ==================== EDGE CONFIG METHODS ====================
    async listEdgeConfigs(args) {
        const params = new URLSearchParams();
        if (args.teamId)
            params.append("teamId", args.teamId);
    ...
    async getEdgeConfigItems(args) {
        const data = await this.vercelFetch(`/v1/edge-config/${args.edgeConfigId}/items`);
        return this.formatResponse(data);
    }
    async updateEdgeConfigItems(args) {
    ...
    async kvListKeys(args) {
        const params = new URLSearchParams();
        if (args.pattern)
            params.append("pattern", args.pattern);
        if (args.cursor)
            params.append("cursor", args.cursor);
    ...
    // ==================== POSTGRES METHODS ====================
    async postgresListDatabases(args) {
        const params = new URLSearchParams();
        if (args.teamId)
            params.append("teamId", args.teamId);
    ...
    async postgresCreateDatabase(args) {
    ...
    async postgresDeleteDatabase(args) {
        const data = await this.vercelFetch(`/v1/postgres/${args.databaseId}`, {
            method: "DELETE",
        });
        return this.formatResponse(data);
    }
    async postgresGetConnectionString(args) {
    ...
    async getFirewallAnalytics(args) {
        const params = new URLSearchParams();
        if (args.from)
            params.append("from", args.from.toString());
        if (args.to)
    ...
    async enableAttackChallengeMode(args) {
    ...
    async getRuntimeLogsStream(args) {
        const params = new URLSearchParams();
        if (args.follow)
    ...
    async getFunctionInvocations(args) {
        const params = new URLSearchParams();
        if (args.from)
            params.append("from", args.from.toString());
        if (args.to)
    ...
    async getTraces(args) {
        ...
        if (args.deploymentId)
            params.append("deploymentId", args.deploymentId);
        if (args.from)
            params.append("from", args.from.toString());
        if (args.to)
            params.append("to", args.to.toString());
    ...
    async updateSpendingLimits(args) {
        const params = new URLSearchParams();
        if (args.teamId)
            params.append("teamId", args.teamId);
        const data = await this.vercelFetch(`/v1/billing/limits?${params}`, {
    ...
    async uninstallIntegration(args) {
        const data = await this.vercelFetch(`/v1/integrations/${args.integrationId}`, {
            method: "DELETE",
        });
        return this.formatResponse(data);
    }
    async listIntegrationConfigurations(args) {
        const data = await this.vercelFetch(`/v1/integrations/${args.integrationId}/configurations`);
        return this.formatResponse(data);
    }
    async updateIntegrationConfiguration(args) {
    ...
    async triggerIntegrationSync(args) {
    ...
    async connectGitRepository(args) {
        const body = {
            type: args.type,
            repo: args.repo,
        };
    ...
    async disconnectGitRepository(args) {
        const data = await this.vercelFetch(`/v9/projects/${args.projectId}`, {
            method: "PATCH",
    ...
    async getMiddlewareMetrics(args) {
        const params = new URLSearchParams();
        if (args.from)
    ...
    async updateTeamMemberRole(args) {
        const data = await this.vercelFetch(`/v1/teams/${args.teamId}/members/${args.userId}`, {
            method: 'PATCH',
...
class NeonMCP {
    ...
    constructor(apiKey) {
        this.server = new index_js_1.Server({ name: '@robinsonai/neon-mcp', version: '2.0.0' }, { capabilities: { tools: {} } });
        this.apiKey = apiKey || '';
    ...
    async createProject(args) {
        const body = {};
        if (args.name)
            body.project = { name: args.name };
        if (args.org_id)
            body.project = { ...body.project, org_id: args.org_id };
        if (args.region_id)
            body.project = { ...body.project, region_id: args.region_id };
        if (args.pg_version)
            body.project = { ...body.project, pg_version: args.pg_version };
    ...
    async getProjectConsumption(args) {
        const params = new URLSearchParams();
        if (args.from)
            params.append('from', args.from);
        if (args.to)
    ...
    async getProjectPermissions(args) {
    ...
    async createBranch(args) {
        const body = { branch: {} };
        if (args.branchName)
            body.branch.name = args.branchName;
        if (args.parent_id)
            body.branch.parent_id = args.parent_id;
    ...
    async describeBranch(args) {
        const response = await this.client.get(`/projects/${args.projectId}/branches/${args.branchId}`);
        return { content: [{ type: 'text', text: JSON.stringify(response.data, null, 2) }] };
    }
    async resetFromParent(args) {
        const body = {};
        if (args.preserveUnderName)
            body.preserve_under_name = args.preserveUnderName;
    ...
    async updateBranch(args) {
        const body = { branch: {} };
        if (args.name)
            body.branch.name = args.name;
        if (args.protected !== undefined)
            body.branch.protected = args.protected;
    ...
    async runSql(args) { return { content: [{ type: 'text', text: 'SQL execution: Not yet implemented' }] }; }
    async runSqlTransaction(args) { return { content: [{ type: 'text', text: 'SQL transaction: Not yet implemented' }] }; }
    async getConnectionString(args) { return { content: [{ type: 'text', text: 'Connection string: Not yet implemented' }] }; }
    async getDatabaseTables(args) { return { content: [{ type: 'text', text: 'Database tables: Not yet implemented' }] }; }
    async describeTableSchema(args) { return { content: [{ type: 'text', text: 'Table schema: Not yet implemented' }] }; }
    async explainSqlStatement(args) { return { content: [{ type: 'text', text: 'Explain SQL: Not yet implemented' }] }; }
    async listSlowQueries(args) { return { content: [{ type: 'text', text: 'Slow queries: Not yet implemented' }] }; }
    async optimizeQuery(args) { return { content: [{ type: 'text', text: 'Query optimization: Not yet implemented' }] }; }
    async suggestIndexes(args) { return { content: [{ type: 'text', text: 'Index suggestions: Not yet implemented' }] }; }
    async analyzeQueryPlan(args) { return { content: [{ type: 'text', text: 'Query plan analysis: Not yet implemented' }] }; }
    async createDatabase(args) { return { content: [{ type: 'text', text: 'Create database: Not yet implemented' }] }; }
    async deleteDatabase(args) { return { content: [{ type: 'text', text: 'Delete database: Not yet implemented' }] }; }
    async listDatabases(args) { return { content: [{ type: 'text', text: 'List databases: Not yet implemented' }] }; }
    async getDatabaseSize(args) { return { content: [{ type: 'text', text: 'Database size: Not yet implemented' }] }; }
    async getDatabaseStats(args) { return { content: [{ type: 'text', text: 'Database stats: Not yet implemented' }] }; }
    async vacuumDatabase(args) { return { content: [{ type: 'text', text: 'Vacuum database: Not yet implemented' }] }; }
    async analyzeDatabase(args) { return { content: [{ type: 'text', text: 'Analyze database: Not yet implemented' }] }; }
    async reindexDatabase(args) { return { content: [{ type: 'text', text: 'Reindex database: Not yet implemented' }] }; }
    async getDatabaseLocks(args) { return { content: [{ type: 'text', text: 'Database locks: Not yet implemented' }] }; }
    async killDatabaseQuery(args) { return { content: [{ type: 'text', text: 'Kill query: Not yet implemented' }] }; }
    async getDatabaseActivity(args) { return { content: [{ type: 'text', text: 'Database activity: Not yet implemented' }] }; }
    async backupDatabase(args) { return { content: [{ type: 'text', text: 'Backup database: Not yet implemented' }] }; }
    async prepareDatabaseMigration(args) { return { content: [{ type: 'text', text: 'Prepare migration: Not yet implemented' }] }; }
    async completeDatabaseMigration(args) { return { content: [{ type: 'text', text: 'Complete migration: Not yet implemented' }] }; }
    async prepareQueryTuning(args) { return { content: [{ type: 'text', text: 'Prepare query tuning: Not yet implemented' }] }; }
    async completeQueryTuning(args) { return { content: [{ type: 'text', text: 'Complete query tuning: Not yet implemented' }] }; }
    async createRole(args) { return { content: [{ type: 'text', text: 'Create role: Not yet implemented' }] }; }
    async deleteRole(args) { return { content: [{ type: 'text', text: 'Delete role: Not yet implemented' }] }; }
    async listRoles(args) { return { content: [{ type: 'text', text: 'List roles: Not yet implemented' }] }; }
    async updateRole(args) { return { content: [{ type: 'text', text: 'Update role: Not yet implemented' }] }; }
    async grantRolePermissions(args) { return { content: [{ type: 'text', text: 'Grant permissions: Not yet implemented' }] }; }
    async revokeRolePermissions(args) { return { content: [{ type: 'text', text: 'Revoke permissions: Not yet implemented' }] }; }
    async getRolePermissions(args) { return { content: [{ type: 'text', text: 'Get permissions: Not yet implemented' }] }; }
    async resetRolePassword(args) { return { content: [{ type: 'text', text: 'Reset password: Not yet implemented' }] }; }
    async createEndpoint(args) { return { content: [{ type: 'text', text: 'Create endpoint: Not yet implemented' }] }; }
    async deleteEndpoint(args) { return { content: [{ type: 'text', text: 'Delete endpoint: Not yet implemented' }] }; }
    async updateEndpoint(args) { return { content: [{ type: 'text', text: 'Update endpoint: Not yet implemented' }] }; }
    async startEndpoint(args) { return { content: [{ type: 'text', text: 'Start endpoint: Not yet implemented' }] }; }
    async suspendEndpoint(args) { return { content: [{ type: 'text', text: 'Suspend endpoint: Not yet implemented' }] }; }
    async restartEndpoint(args) { return { content: [{ type: 'text', text: 'Restart endpoint: Not yet implemented' }] }; }
    async getEndpointMetrics(args) { return { content: [{ type: 'text', text: 'Endpoint metrics: Not yet implemented' }] }; }
    async setEndpointAutoscaling(args) { return { content: [{ type: 'text', text: 'Set autoscaling: Not yet implemented' }] }; }
    async getEndpointLogs(args) { return { content: [{ type: 'text', text: 'Endpoint logs: Not yet implemented' }] }; }
    async setEndpointPooling(args) { return { content: [{ type: 'text', text: 'Set pooling: Not yet implemented' }] }; }
    async getQueryStatistics(args) { return { content: [{ type: 'text', text: 'Query statistics: Not yet implemented' }] }; }
    async getSlowQueryLog(args) { return { content: [{ type: 'text', text: 'Slow query log: Not yet implemented' }] }; }
    async getConnectionStats(args) { return { content: [{ type: 'text', text: 'Connection stats: Not yet implemented' }] }; }
    async getStorageMetrics(args) { return { content: [{ type: 'text', text: 'Storage metrics: Not yet implemented' }] }; }
    async getComputeMetrics(args) { return { content: [{ type: 'text', text: 'Compute metrics: Not yet implemented' }] }; }
    async getIoMetrics(args) { return { content: [{ type: 'text', text: 'I/O metrics: Not yet implemented' }] }; }
    async getCacheHitRatio(args) { return { content: [{ type: 'text', text: 'Cache hit ratio: Not yet implemented' }] }; }
    async getIndexUsage(args) { return { content: [{ type: 'text', text: 'Index usage: Not yet implemented' }] }; }
    async getTableBloat(args) { return { content: [{ type: 'text', text: 'Table bloat: Not yet implemented' }] }; }
    async getReplicationLag(args) { return { content: [{ type: 'text', text: 'Replication lag: Not yet implemented' }] }; }
    async getCheckpointStats(args) { return { content: [{ type: 'text', text: 'Checkpoint stats: Not yet implemented' }] }; }
    async getWalStats(args) { return { content: [{ type: 'text', text: 'WAL stats: Not yet implemented' }] }; }
    async setMonitoringAlerts(args) { return { content: [{ type: 'text', text: 'Set alerts: Not yet implemented' }] }; }
    async getAlertHistory(args) { return { content: [{ type: 'text', text: 'Alert history: Not yet implemented' }] }; }
    async getPerformanceInsights(args) { return { content: [{ type: 'text', text: 'Performance insights: Not yet implemented' }] }; }
    async listBackups(args) { return { content: [{ type: 'text', text: 'List backups: Not yet implemented' }] }; }
    async createBackup(args) { return { content: [{ type: 'text', text: 'Create backup: Not yet implemented' }] }; }
    async restoreBackup(args) { return { content: [{ type: 'text', text: 'Restore backup: Not yet implemented' }] }; }
    async deleteBackup(args) { return { content: [{ type: 'text', text: 'Delete backup: Not yet implemented' }] }; }
    async getBackupStatus(args) { return { content: [{ type: 'text', text: 'Backup status: Not yet implemented' }] }; }
    async scheduleBackup(args) { return { content: [{ type: 'text', text: 'Schedule backup: Not yet implemented' }] }; }
    async exportBackup(args) { return { content: [{ type: 'text', text: 'Export backup: Not yet implemented' }] }; }
    async validateBackup(args) { return { content: [{ type: 'text', text: 'Validate backup: Not yet implemented' }] }; }
    async enableIpAllowlist(args) { return { content: [{ type: 'text', text: 'Enable IP allowlist: Not yet implemented' }] }; }
    async getIpAllowlist(args) { return { content: [{ type: 'text', text: 'Get IP allowlist: Not yet implemented' }] }; }
    async enableSslEnforcement(args) { return { content: [{ type: 'text', text: 'Enable SSL: Not yet implemented' }] }; }
    async rotateCredentials(args) { return { content: [{ type: 'text', text: 'Rotate credentials: Not yet implemented' }] }; }
    async getAuditLog(args) { return { content: [{ type: 'text', text: 'Audit log: Not yet implemented' }] }; }
    async enableEncryption(args) { return { content: [{ type: 'text', text: 'Enable encryption: Not yet implemented' }] }; }
    async getSecurityScan(args) { return { content: [{ type: 'text', text: 'Security scan: Not yet implemented' }] }; }
    async setPasswordPolicy(args) { return { content: [{ type: 'text', text: 'Set password policy: Not yet implemented' }] }; }
    async enable2fa(args) { return { content: [{ type: 'text', text: 'Enable 2FA: Not yet implemented' }] }; }
    async getComplianceReport(args) { return { content: [{ type: 'text', text: 'Compliance report: Not yet implemented' }] }; }
    async getCostBreakdown(args) { return { content: [{ type: 'text', text: 'Cost breakdown: Not yet implemented' }] }; }
    async getCostForecast(args) { return { content: [{ type: 'text', text: 'Cost forecast: Not yet implemented' }] }; }
    async setCostAlerts(args) { return { content: [{ type: 'text', text: 'Set cost alerts: Not yet implemented' }] }; }
    async getCostOptimizationTips(args) { return { content: [{ type: 'text', text: 'Cost optimization: Not yet implemented' }] }; }
    async getBillingHistory(args) { return { content: [{ type: 'text', text: 'Billing history: Not yet implemented' }] }; }
    async exportCostReport(args) { return { content: [{ type: 'text', text: 'Export cost report: Not yet implemented' }] }; }
    async setBudgetLimits(args) { return { content: [{ type: 'text', text: 'Set budget limits: Not yet implemented' }] }; }
    async getResourceRecommendations(args) { return { content: [{ type: 'text', text: 'Resource recommendations: Not yet implemented' }] }; }
    async createWebhook(args) { return { content: [{ type: 'text', text: 'Create webhook: Not yet implemented' }] }; }
    async listWebhooks(args) { return { content: [{ type: 'text', text: 'List webhooks: Not yet implemented' }] }; }
    async deleteWebhook(args) { return { content: [{ type: 'text', text: 'Delete webhook: Not yet implemented' }] }; }
    async testWebhook(args) { return { content: [{ type: 'text', text: 'Test webhook: Not yet implemented' }] }; }
    async getWebhookLogs(args) { return { content: [{ type: 'text', text: 'Webhook logs: Not yet implemented' }] }; }
    async createApiKey(args) { return { content: [{ type: 'text', text: 'Create API key: Not yet implemented' }] }; }
    async detectNPlusOne(args) { return { content: [{ type: 'text', text: 'Detect N+1: Not yet implemented' }] }; }
    async suggestPartitioning(args) { return { content: [{ type: 'text', text: 'Suggest partitioning: Not yet implemented' }] }; }
    async analyzeTableStatistics(args) { return { content: [{ type: 'text', text: 'Table statistics: Not yet implemented' }] }; }
    async suggestVacuumStrategy(args) { return { content: [{ type: 'text', text: 'Vacuum strategy: Not yet implemented' }] }; }
    async detectMissingIndexes(args) { return { content: [{ type: 'text', text: 'Missing indexes: Not yet implemented' }] }; }
    async analyzeJoinPerformance(args) { return { content: [{ type: 'text', text: 'Join performance: Not yet implemented' }] }; }
    async suggestMaterializedViews(args) { return { content: [{ type: 'text', text: 'Materialized views: Not yet implemented' }] }; }
    async getTableDependencies(args) { return { content: [{ type: 'text', text: 'Table dependencies: Not yet implemented' }] }; }
    async suggestQueryRewrite(args) { return { content: [{ type: 'text', text: 'Query rewrite: Not yet implemented' }] }; }
    async analyzeDeadlocks(args) { return { content: [{ type: 'text', text: 'Analyze deadlocks: Not yet implemented' }] }; }
    async provisionNeonAuth(args) { return { content: [{ type: 'text', text: 'Provision Neon Auth: Not yet implemented' }] }; }
    // API KEY MANAGEMENT
    async listApiKeys(args) {
        const response = await this.client.get('/api_keys');
        return { content: [{ type: 'text', text: JSON.stringify(response.data, null, 2) }] };
    }
    async createApiKeyForProject(args) {
    ...
    // CONNECTION POOLING
    async getConnectionPoolerConfig(args) {
    ...
    async updateConnectionPoolerConfig(args) {
        const body = { endpoint: {} };
        if (args.poolMode)
            body.endpoint.pooler_mode = args.poolMode;
        if (args.poolSize !== undefined)
            body.endpoint.settings = { ...body.endpoint.settings, pool_size: args.poolSize };
        if (args.maxClientConn !== undefined)
            body.endpoint.settings = { ...body.endpoint.settings, max_client_conn: args.maxClientConn };
        const response = await this.client.patch(`/projects/${args.projectId}/endpoints/${args.endpointId}`, body);
        return { content: [{ type: 'text', text: JSON.stringify(response.data, null, 2) }] };
    }
    // READ REPLICAS
    async createReadReplica(args) {
        const body = {
            endpoint: {
        ...
        if (args.region)
            body.endpoint.region_id = args.region;
        const response = await this.client.post(`/projects/${args.projectId}/endpoints`, body);
        return { content: [{ type: 'text', text: JSON.stringify(response.data, null, 2) }] };
    }
    async listReadReplicas(args) {
        const response = await this.client.get(`/projects/${args.projectId}/endpoints`);
        const readReplicas = response.data.endpoints?.filter((ep) => ep.type === 'read_only' && ep.branch_id === args.branchId) || [];
    ...
    async getExtensionDetails(args) {
        const branchId = args.branchId || 'main';
        const dbName = args.databaseName || 'neondb';
    ...
    formatConnectionString(uri, format) {
        switch (format) {
            case 'neon_psql':
                return `psql "${uri}"`;
            case 'neon_jdbc':
    ...
    async getConnectionExamples(args) {
        const response = await this.client.get(`/projects/${args.projectId}/connection_uri`, {
            params: {
                branch_id: args.branchId,
                database_name: args.databaseName
    ...
    async createProjectForRAD(args) {
        if (!this.isEnabled) {
            return {
                content: [{
                        type: 'text',
    ...
    async deploySchema(args) {
        ...
        for (const sql of statements) {
            try {
                const response = await this.client.post(`/projects/${args.projectId}/branches/${args.branchId || 'main'}/databases/${args.databaseName || 'neondb'}/query`, { query: sql + ';' });
    ...
    async setupRADDatabase(args) {
        ...
        try {
            ...
            await this.client.post(`/projects/${project.id}/branches/main/databases`, { database: { name: args.databaseName || 'rad_production', owner_name: 'neondb_owner' } });
...
class UnifiedToolkit {
    ...
    constructor() {
        ...
        if (githubToken)
            this.githubServer = new GitHubMCP(githubToken);
        const vercelToken = process.env.VERCEL_TOKEN;
        if (vercelToken)
            this.vercelServer = new VercelMCP();
        const neonApiKey = process.env.NEON_API_KEY;
        if (neonApiKey)
            this.neonServer = new NeonMCP(neonApiKey);
    }
    async run() {
