...
// Workflow Operations
// ============================================================================
export async function handleN8nWorkflowTrigger(args) {
    const { workflow_id, data } = args;
    return await fastAPIClient.n8nTriggerWorkflow(workflow_id, data);
}
export async function handleN8nWorkflowList(args) {
    const { active } = args;
...
export async function handleN8nWorkflowGet(args) {
    const { workflow_id } = args;
    return await fastAPIClient.n8nGetWorkflow(workflow_id);
}
export async function handleN8nWorkflowCreate(args) {
...
export async function handleN8nWorkflowUpdate(args) {
...
export async function handleN8nWorkflowDelete(args) {
    const { workflow_id } = args;
    return await fastAPIClient.request(`/gateway/n8n/api/v1/workflows/${workflow_id}`, {
        method: 'DELETE',
    });
...
// ============================================================================
export async function handleN8nExecutionGetStatus(args) {
    const { execution_id } = args;
    return await fastAPIClient.n8nGetExecutionStatus(execution_id);
}
export async function handleN8nExecutionList(args) {
...
export async function handleN8nExecutionDelete(args) {
    const { execution_id } = args;
...
// ============================================================================
export async function handleN8nCredentialList(args) {
    const { type } = args;
...
export async function handleN8nCredentialCreate(args) {
...
// Admin Operations
// ============================================================================
export async function handleN8nConnectionTest(args) {
    try {
