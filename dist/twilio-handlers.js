...
// ============================================================
export async function twilioSendSms(args) {
...
export async function twilioSendMms(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioSendWhatsapp(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { to, from, body } = args;
...
export async function twilioGetMessage(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioListMessages(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioDeleteMessage(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { messageSid } = args;
...
export async function twilioUpdateMessage(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioCreateMessagingService(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioGetMessagingService(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioListMessagingServices(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { limit } = args;
...
export async function twilioUpdateMessagingService(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioDeleteMessagingService(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { serviceSid } = args;
...
export async function twilioAddPhoneToService(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioRemovePhoneFromService(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { serviceSid, phoneNumberSid } = args;
...
export async function twilioListServicePhoneNumbers(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { serviceSid } = args;
...
export async function twilioScheduleMessage(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioCancelScheduledMessage(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { messageSid } = args;
...
export async function twilioGetMessageMedia(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
export async function twilioListMessageMedia(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { messageSid } = args;
...
export async function twilioDeleteMessageMedia(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { messageSid, mediaSid } = args;
