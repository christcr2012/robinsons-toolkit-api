...
`;
   ...
   */
  private getDefaultQuality(complexity?): 'fast' | 'balanced' | 'best' {
    switch (complexity) {
      case 'simple':
        return 'fast';
      case 'medium':
   ...
   */
  private selectModel(complexity?){
    switch (complexity) {
      case 'simple':
   ...
   */
  private parseGeneratedCode(text): {
    code;
    files?: Array;
  } {
   ...
   */
  private extractPathCandidate(raw?): string | undefined {
