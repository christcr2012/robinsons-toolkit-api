...
// KV (20 handlers)
// ============================================================
export async function cloudflareListKVNamespaces(args) {
...
export async function cloudflareCreateKVNamespace(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { title } = args;
...
export async function cloudflareGetKVNamespace(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareRenameKVNamespace(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteKVNamespace(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { namespaceId } = args;
...
export async function cloudflareListKVKeys(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareReadKVValue(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareWriteKVValue(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteKVValue(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { namespaceId, key } = args;
...
export async function cloudflareWriteKVBulk(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteKVBulk(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareGetKVMetadata(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { namespaceId, key } = args;
...
export async function cloudflareListKVByPrefix(args) {
    return cloudflareListKVKeys.call(this, args);
}
export async function cloudflareGetKVWithMetadata(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { namespaceId, key } = args;
...
export async function cloudflareSetKVExpiration(args) {
    return cloudflareWriteKVValue.call(this, args);
}
export async function cloudflareGetKVUsage(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { namespaceId } = args;
...
export async function cloudflareExportKVNamespace(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { namespaceId } = args;
...
export async function cloudflareImportKVNamespace(args) {
    return cloudflareWriteKVBulk.call(this, args);
}
export async function cloudflareSearchKVKeys(args) {
    return cloudflareListKVKeys.call(this, args);
}
export async function cloudflareGetKVStats(args) {
    return cloudflareGetKVUsage.call(this, args);
}
// ============================================================
// R2 (20 handlers)
// ============================================================
export async function cloudflareListR2Buckets(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareCreateR2Bucket(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareGetR2Bucket(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteR2Bucket(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { bucketName } = args;
...
export async function cloudflareListR2Objects(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareUploadR2Object(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDownloadR2Object(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
export async function cloudflareDeleteR2Object(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { bucketName, key } = args;
...
export async function cloudflareGetR2ObjectMetadata(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { bucketName, key } = args;
...
export async function cloudflareCopyR2Object(args) {
    return formatCloudflareResponse({ message: 'Use Cloudflare dashboard or API for copy operations' });
}
export async function cloudflareMoveR2Object(args) {
    return formatCloudflareResponse({ message: 'Use Cloudflare dashboard or API for move operations' });
}
export async function cloudflareListR2MultipartUploads(args) {
    return formatCloudflareResponse({ message: 'Use Cloudflare dashboard or API for multipart uploads' });
}
export async function cloudflareCreateR2MultipartUpload(args) {
    return formatCloudflareResponse({ message: 'Use Cloudflare dashboard or API for multipart uploads' });
}
export async function cloudflareUploadR2Part(args) {
    return formatCloudflareResponse({ message: 'Use Cloudflare dashboard or API for multipart uploads' });
}
export async function cloudflareCompleteR2MultipartUpload(args) {
    return formatCloudflareResponse({ message: 'Use Cloudflare dashboard or API for multipart uploads' });
}
export async function cloudflareAbortR2MultipartUpload(args) {
    return formatCloudflareResponse({ message: 'Use Cloudflare dashboard or API for multipart uploads' });
}
export async function cloudflareGetR2BucketCors(args) {
    return formatCloudflareResponse({ message: 'Use Cloudflare dashboard or API for CORS configuration' });
}
export async function cloudflareSetR2BucketCors(args) {
    return formatCloudflareResponse({ message: 'Use Cloudflare dashboard or API for CORS configuration' });
}
export async function cloudflareGetR2BucketLifecycle(args) {
