...
// ============================================================
export async function playwrightLaunchBrowser(args) {
...
export async function playwrightCloseBrowser(args) {
    if (this.playwrightBrowser) {
...
export async function playwrightNewContext(args) {
    if (!this.playwrightBrowser)
...
export async function playwrightCloseContext(args) {
...
export async function playwrightNewPage(args) {
    if (!this.playwrightContext) {
        if (!this.playwrightBrowser)
            throw new Error('Browser not launched');
...
export async function playwrightClosePage(args) {
...
export async function playwrightGetPages(args) {
    if (!this.playwrightContext)
...
export async function playwrightSetViewport(args) {
    if (!this.playwrightPage)
...
export async function playwrightSetUserAgent(args) {
    if (!this.playwrightContext)
        throw new Error('No context available');
...
export async function playwrightSetExtraHttpHeaders(args) {
    if (!this.playwrightContext)
        throw new Error('No context available');
    const { headers } = args;
...
// ============================================================
export async function playwrightGoto(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
...
export async function playwrightGoBack(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { options = {} } = args;
...
export async function playwrightGoForward(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { options = {} } = args;
...
export async function playwrightReload(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { options = {} } = args;
...
export async function playwrightWaitForLoadState(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
...
export async function playwrightWaitForUrl(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { url, options = {} } = args;
...
// ============================================================
export async function playwrightClick(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
...
export async function playwrightDblclick(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector, options = {} } = args;
...
export async function playwrightFill(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
...
export async function playwrightType(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
...
export async function playwrightPress(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
...
export async function playwrightSelectOption(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
...
export async function playwrightCheck(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector, options = {} } = args;
...
export async function playwrightUncheck(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector, options = {} } = args;
...
export async function playwrightHover(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector, options = {} } = args;
...
export async function playwrightFocus(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector, options = {} } = args;
...
export async function playwrightGetAttribute(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
...
export async function playwrightGetTextContent(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector } = args;
...
export async function playwrightGetInnerText(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector } = args;
...
export async function playwrightGetInnerHtml(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector } = args;
...
// ============================================================
export async function playwrightWaitForSelector(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector, options = {} } = args;
...
export async function playwrightWaitForTimeout(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { timeout } = args;
...
export async function playwrightIsVisible(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector } = args;
...
export async function playwrightIsHidden(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector } = args;
...
export async function playwrightIsEnabled(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector } = args;
...
export async function playwrightIsDisabled(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector } = args;
...
export async function playwrightIsChecked(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector } = args;
...
export async function playwrightIsEditable(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector } = args;
...
export async function playwrightCountElements(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { selector } = args;
...
export async function playwrightEvaluate(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
...
// ============================================================
export async function playwrightScreenshot(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
...
export async function playwrightScreenshotElement(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
...
export async function playwrightPdf(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
    const { path, options = {} } = args;
...
export async function playwrightStartVideo(args) {
    if (!this.playwrightContext)
        throw new Error('No context available');
    const { options = {} } = args;
...
export async function playwrightStopVideo(args) {
    if (!this.playwrightPage)
        throw new Error('No page available');
