...
exports.stripeAccountCreate = stripeAccountCreate;
exports.stripeAccountRetrieve = stripeAccountRetrieve;
exports.stripeAccountUpdate = stripeAccountUpdate;
exports.stripeAccountDelete = stripeAccountDelete;
exports.stripeAccountList = stripeAccountList;
exports.stripeTransferCreate = stripeTransferCreate;
exports.stripeTransferRetrieve = stripeTransferRetrieve;
exports.stripeTransferUpdate = stripeTransferUpdate;
exports.stripeTransferReverse = stripeTransferReverse;
exports.stripeTransferList = stripeTransferList;
exports.stripeApplicationFeeRetrieve = stripeApplicationFeeRetrieve;
exports.stripeApplicationFeeRefund = stripeApplicationFeeRefund;
exports.stripeApplicationFeeList = stripeApplicationFeeList;
exports.stripeCapabilityRetrieve = stripeCapabilityRetrieve;
exports.stripeCapabilityUpdate = stripeCapabilityUpdate;
exports.stripeCapabilityList = stripeCapabilityList;
exports.stripeAccountLinkCreate = stripeAccountLinkCreate;
exports.stripeAccountSessionCreate = stripeAccountSessionCreate;
exports.stripeExternalAccountCreate = stripeExternalAccountCreate;
exports.stripeExternalAccountDelete = stripeExternalAccountDelete;
exports.stripeEventRetrieve = stripeEventRetrieve;
exports.stripeEventList = stripeEventList;
exports.stripeFileCreate = stripeFileCreate;
exports.stripeFileRetrieve = stripeFileRetrieve;
exports.stripeFileList = stripeFileList;
exports.stripeDisputeRetrieve = stripeDisputeRetrieve;
exports.stripeDisputeUpdate = stripeDisputeUpdate;
exports.stripeDisputeClose = stripeDisputeClose;
exports.stripeDisputeList = stripeDisputeList;
exports.stripeWebhookConstructEvent = stripeWebhookConstructEvent;
exports.stripeWebhookVerifySignature = stripeWebhookVerifySignature;
exports.stripeSetupIntentCreate = stripeSetupIntentCreate;
exports.stripeSetupIntentRetrieve = stripeSetupIntentRetrieve;
exports.stripeSetupIntentUpdate = stripeSetupIntentUpdate;
exports.stripeSetupIntentConfirm = stripeSetupIntentConfirm;
exports.stripeSetupIntentCancel = stripeSetupIntentCancel;
exports.stripeCheckoutSessionCreate = stripeCheckoutSessionCreate;
exports.stripeCheckoutSessionRetrieve = stripeCheckoutSessionRetrieve;
exports.stripeCheckoutSessionExpire = stripeCheckoutSessionExpire;
exports.stripeCheckoutSessionList = stripeCheckoutSessionList;
...
// ============================================================
// ACCOUNTS (5 handlers)
async function stripeAccountCreate(args) {
...
async function stripeAccountRetrieve(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeAccountUpdate(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeAccountDelete(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeAccountList(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeTransferCreate(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeTransferRetrieve(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeTransferUpdate(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeTransferReverse(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeTransferList(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeApplicationFeeRetrieve(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeApplicationFeeRefund(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeApplicationFeeList(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeCapabilityRetrieve(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeCapabilityUpdate(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeCapabilityList(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeAccountLinkCreate(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeAccountSessionCreate(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeExternalAccountCreate(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeExternalAccountDelete(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
// ============================================================
// EVENTS (2 handlers)
async function stripeEventRetrieve(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeEventList(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
// FILES (3 handlers)
async function stripeFileCreate(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeFileRetrieve(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeFileList(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
// DISPUTES (4 handlers)
async function stripeDisputeRetrieve(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeDisputeUpdate(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeDisputeClose(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeDisputeList(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
// WEBHOOKS (2 handlers)
async function stripeWebhookConstructEvent(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeWebhookVerifySignature(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
        const { payload, signature, secret } = args;
...
async function stripeSetupIntentCreate(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeSetupIntentRetrieve(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeSetupIntentUpdate(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeSetupIntentConfirm(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeSetupIntentCancel(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeCheckoutSessionCreate(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeCheckoutSessionRetrieve(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeCheckoutSessionExpire(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
...
async function stripeCheckoutSessionList(args) {
    if (!this.stripeClient)
        throw new Error('Stripe client not initialized');
    try {
