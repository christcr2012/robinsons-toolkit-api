...
// Query Execution
// ============================================================================
export async function handleNeo4jQueryExecute(args) {
...
// ============================================================================
export async function handleNeo4jKnowledgeGraphCreateNode(args) {
...
export async function handleNeo4jKnowledgeGraphCreateRelationship(args) {
...
export async function handleNeo4jKnowledgeGraphQuery(args) {
...
// Node Operations
// ============================================================================
export async function handleNeo4jNodeCreate(args) {
    const { label, properties } = args;
...
export async function handleNeo4jNodeDelete(args) {
...
export async function handleNeo4jNodeSearch(args) {
...
// ============================================================================
export async function handleNeo4jRelationshipCreate(args) {
...
export async function handleNeo4jRelationshipGet(args) {
...
export async function handleNeo4jRelationshipDelete(args) {
    const { relationship_id } = args;
    const cypher = `MATCH ()-[r]->() WHERE id(r) = $relationship_id DELETE r`;
    return await fastAPIClient.neo4jQuery(cypher, { relationship_id: parseInt(relationship_id) });
}
export async function handleNeo4jRelationshipSearch(args) {
...
// Pattern Matching
// ============================================================================
export async function handleNeo4jPatternMatch(args) {
...
export async function handleNeo4jPathFind(args) {
...
// Schema & Admin
// ============================================================================
export async function handleNeo4jSchemaGet(args) {
    const cypher = 'CALL db.schema.visualization()';
    return await fastAPIClient.neo4jQuery(cypher);
}
export async function handleNeo4jStatsGet(args) {
    const cypher = `
    MATCH (n)
...
export async function handleNeo4jConnectionTest(args) {
    try {
...
export async function handleNeo4jDatabaseList(args) {
    const cypher = 'SHOW DATABASES';
    return await fastAPIClient.neo4jQuery(cypher);
}
export async function handleNeo4jConstraintCreate(args) {
