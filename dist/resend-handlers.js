...
export async function resendGetEmail(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { emailId } = args;
...
export async function resendListEmails(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
export async function resendCancelEmail(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { emailId } = args;
...
export async function resendSendBatchEmails(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { emails } = args;
...
export async function resendScheduleEmail(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
export async function resendGetEmailEvents(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { emailId } = args;
...
export async function resendResendEmail(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
export async function resendGetEmailStats(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
export async function resendValidateEmail(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { email } = args;
...
// DOMAINS - 10 handlers
// ============================================================
export async function resendListDomains(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
export async function resendGetDomain(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { domainId } = args;
...
export async function resendCreateDomain(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
export async function resendDeleteDomain(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { domainId } = args;
...
export async function resendVerifyDomain(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { domainId } = args;
...
export async function resendUpdateDomain(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
export async function resendGetDomainDns(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { domainId } = args;
...
export async function resendGetDomainStats(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
export async function resendTestDomain(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
export async function resendGetDomainReputation(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { domainId } = args;
...
// API KEYS - 5 handlers
// ============================================================
export async function resendListApiKeys(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
export async function resendCreateApiKey(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
...
export async function resendDeleteApiKey(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { apiKeyId } = args;
...
export async function resendGetApiKey(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
        const { apiKeyId } = args;
...
export async function resendUpdateApiKey(args) {
    if (!this.resendClient)
        throw new Error('Resend client not initialized');
    try {
