...
class GitHubMCP {
    ...
    constructor(token) {
        this.server = new Server({ name: '@robinsonai/github-mcp', version: '2.0.0' }, { capabilities: { tools: {} } });
        this.token = token;
        this.setupHandlers();
    }
...
class NeonMCP {
    ...
    constructor(apiKey) {
        this.server = new Server({ name: '@robinsonai/neon-mcp', version: '2.0.0' }, { capabilities: { tools: {} } });
        this.apiKey = apiKey || '';
