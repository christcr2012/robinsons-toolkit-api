...
// Query Execution
// ============================================================================
export async function handlePostgresQueryExecute(args) {
...
// Vector Search
// ============================================================================
export async function handlePostgresVectorSearch(args) {
...
// Chat History
// ============================================================================
export async function handlePostgresChatHistoryStore(args) {
...
export async function handlePostgresChatHistoryRetrieve(args) {
...
export async function handlePostgresChatHistorySearch(args) {
...
// Embeddings
// ============================================================================
export async function handlePostgresEmbeddingsStore(args) {
...
export async function handlePostgresEmbeddingsSearch(args) {
...
export async function handlePostgresTableDrop(args) {
...
// Index Management
// ============================================================================
export async function handlePostgresIndexCreate(args) {
...
export async function handlePostgresIndexList(args) {
    const { table_name } = args;
    let sql = `
...
export async function handlePostgresIndexDrop(args) {
...
// ============================================================================
export async function handlePostgresTransactionBegin(args) {
    const { isolation_level = 'READ COMMITTED' } = args;
    const sql = `BEGIN TRANSACTION ISOLATION LEVEL ${isolation_level}`;
    return await fastAPIClient.postgresExecute(sql);
}
export async function handlePostgresTransactionCommit(args) {
    const sql = 'COMMIT';
    return await fastAPIClient.postgresExecute(sql);
}
export async function handlePostgresTransactionRollback(args) {
    const sql = 'ROLLBACK';
    return await fastAPIClient.postgresExecute(sql);
}
// ============================================================================
// Backup & Restore
// ============================================================================
export async function handlePostgresBackupCreate(args) {
...
export async function handlePostgresBackupRestore(args) {
...
// ============================================================================
export async function handlePostgresStatsGet(args) {
...
export async function handlePostgresConnectionTest(args) {
    try {
...
// Schema Management
// ============================================================================
export async function handlePostgresSchemaCreate(args) {
    const { schema_name } = args;
    const sql = `CREATE SCHEMA ${schema_name}`;
    return await fastAPIClient.postgresExecute(sql);
}
export async function handlePostgresSchemaList(args) {
    const sql = `
    SELECT schema_name
...
// User Management
// ============================================================================
export async function handlePostgresUserCreate(args) {
...
export async function handlePostgresUserList(args) {
    const sql = `
