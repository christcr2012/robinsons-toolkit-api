...
function normalize(root, file: string | undefined){
  if (!file) return '';
...
function detectPatterns(root, symbolIndex: SymbolIndex | null, importGraph: ImportEdge[] | null): PatternSummary[] {
...
export class ArchitectureMemory {
  ...
  async refresh(symbolIndex: SymbolIndex | null, importGraph: ImportEdge[] | null){
  ...
  summary(): { root; total; patterns: PatternSummary[] } {
    return {
      root: this.root,
  ...
  annotateResults(query, hits: Hit[]): Hit[] {
