...
exports.twilioListTollFreeNumbers = twilioListTollFreeNumbers;
exports.twilioListLocalNumbers = twilioListLocalNumbers;
exports.twilioListMobileNumbers = twilioListMobileNumbers;
exports.twilioLookupPhoneNumber = twilioLookupPhoneNumber;
exports.twilioPortPhoneNumber = twilioPortPhoneNumber;
exports.twilioGetPortRequest = twilioGetPortRequest;
exports.twilioListPortRequests = twilioListPortRequests;
exports.twilioCancelPortRequest = twilioCancelPortRequest;
exports.twilioCreateVerification = twilioCreateVerification;
exports.twilioCheckVerification = twilioCheckVerification;
exports.twilioCreateVerifyService = twilioCreateVerifyService;
exports.twilioGetVerifyService = twilioGetVerifyService;
exports.twilioListVerifyServices = twilioListVerifyServices;
exports.twilioUpdateVerifyService = twilioUpdateVerifyService;
exports.twilioDeleteVerifyService = twilioDeleteVerifyService;
exports.twilioCreateRateLimit = twilioCreateRateLimit;
exports.twilioListRateLimits = twilioListRateLimits;
exports.twilioDeleteRateLimit = twilioDeleteRateLimit;
exports.twilioCreateVideoRoom = twilioCreateVideoRoom;
exports.twilioGetVideoRoom = twilioGetVideoRoom;
exports.twilioListVideoRooms = twilioListVideoRooms;
exports.twilioCompleteVideoRoom = twilioCompleteVideoRoom;
exports.twilioListVideoParticipants = twilioListVideoParticipants;
exports.twilioGetVideoParticipant = twilioGetVideoParticipant;
exports.twilioUpdateVideoParticipant = twilioUpdateVideoParticipant;
exports.twilioListVideoRecordings = twilioListVideoRecordings;
exports.twilioGetVideoRecording = twilioGetVideoRecording;
exports.twilioDeleteVideoRecording = twilioDeleteVideoRecording;
exports.twilioCreateConversation = twilioCreateConversation;
exports.twilioGetConversation = twilioGetConversation;
exports.twilioListConversations = twilioListConversations;
exports.twilioUpdateConversation = twilioUpdateConversation;
exports.twilioDeleteConversation = twilioDeleteConversation;
exports.twilioAddConversationParticipant = twilioAddConversationParticipant;
exports.twilioListConversationParticipants = twilioListConversationParticipants;
exports.twilioRemoveConversationParticipant = twilioRemoveConversationParticipant;
exports.twilioSendConversationMessage = twilioSendConversationMessage;
exports.twilioListConversationMessages = twilioListConversationMessages;
...
// ============================================================
async function twilioListTollFreeNumbers(args) {
...
async function twilioListLocalNumbers(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioListMobileNumbers(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioLookupPhoneNumber(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioPortPhoneNumber(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioGetPortRequest(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioListPortRequests(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioCancelPortRequest(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { portRequestSid } = args;
...
// ============================================================
async function twilioCreateVerification(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioCheckVerification(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { to, code } = args;
...
async function twilioCreateVerifyService(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioGetVerifyService(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioListVerifyServices(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { limit } = args;
...
async function twilioUpdateVerifyService(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioDeleteVerifyService(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { serviceSid } = args;
...
async function twilioCreateRateLimit(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioListRateLimits(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { serviceSid } = args;
...
async function twilioDeleteRateLimit(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
// ============================================================
async function twilioCreateVideoRoom(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioGetVideoRoom(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { roomSid } = args;
...
async function twilioListVideoRooms(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioCompleteVideoRoom(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { roomSid } = args;
...
async function twilioListVideoParticipants(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioGetVideoParticipant(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioUpdateVideoParticipant(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioListVideoRecordings(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioGetVideoRecording(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioDeleteVideoRecording(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { recordingSid } = args;
...
// ============================================================
async function twilioCreateConversation(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioGetConversation(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioListConversations(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { limit } = args;
...
async function twilioUpdateConversation(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioDeleteConversation(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { conversationSid } = args;
...
async function twilioAddConversationParticipant(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioListConversationParticipants(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
        const { conversationSid } = args;
...
async function twilioRemoveConversationParticipant(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioSendConversationMessage(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
...
async function twilioListConversationMessages(args) {
    if (!this.twilioClient)
        throw new Error('Twilio client not initialized');
    try {
