/**
 * GitHub PR Requested Reviewers REST API
 * GET /api/github/repos/[owner]/[repo]/pulls/[pull_number]/requested_reviewers - List requested reviewers
 */
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    console.error('GitHub PR requested reviewers API error:', error);
