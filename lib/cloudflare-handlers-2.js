...
exports.cloudflareGetAnalytics = cloudflareGetAnalytics;
exports.cloudflareGetZonePlan = cloudflareGetZonePlan;
exports.cloudflareListRateLimits = cloudflareListRateLimits;
exports.cloudflareCreateRateLimit = cloudflareCreateRateLimit;
exports.cloudflareDeleteRateLimit = cloudflareDeleteRateLimit;
exports.cloudflareListLoadBalancers = cloudflareListLoadBalancers;
exports.cloudflareCreateLoadBalancer = cloudflareCreateLoadBalancer;
exports.cloudflareDeleteLoadBalancer = cloudflareDeleteLoadBalancer;
exports.cloudflareListWorkers = cloudflareListWorkers;
exports.cloudflareGetWorker = cloudflareGetWorker;
exports.cloudflareUploadWorker = cloudflareUploadWorker;
exports.cloudflareDeleteWorker = cloudflareDeleteWorker;
exports.cloudflareListWorkerRoutes = cloudflareListWorkerRoutes;
exports.cloudflareCreateWorkerRoute = cloudflareCreateWorkerRoute;
exports.cloudflareUpdateWorkerRoute = cloudflareUpdateWorkerRoute;
exports.cloudflareDeleteWorkerRoute = cloudflareDeleteWorkerRoute;
exports.cloudflareListWorkerCronTriggers = cloudflareListWorkerCronTriggers;
exports.cloudflareCreateWorkerCronTrigger = cloudflareCreateWorkerCronTrigger;
exports.cloudflareDeleteWorkerCronTrigger = cloudflareDeleteWorkerCronTrigger;
exports.cloudflareGetWorkerSettings = cloudflareGetWorkerSettings;
exports.cloudflareUpdateWorkerSettings = cloudflareUpdateWorkerSettings;
exports.cloudflareListWorkerSubdomain = cloudflareListWorkerSubdomain;
exports.cloudflareCreateWorkerSubdomain = cloudflareCreateWorkerSubdomain;
exports.cloudflareGetWorkerTail = cloudflareGetWorkerTail;
exports.cloudflareListWorkerSecrets = cloudflareListWorkerSecrets;
exports.cloudflareCreateWorkerSecret = cloudflareCreateWorkerSecret;
exports.cloudflareDeleteWorkerSecret = cloudflareDeleteWorkerSecret;
...
// ============================================================
async function cloudflareGetAnalytics(args) {
...
async function cloudflareGetZonePlan(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { zoneId } = args;
...
async function cloudflareListRateLimits(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareCreateRateLimit(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareDeleteRateLimit(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareListLoadBalancers(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { zoneId } = args;
...
async function cloudflareCreateLoadBalancer(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareDeleteLoadBalancer(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
// WORKERS (25 handlers)
// ============================================================
async function cloudflareListWorkers(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareGetWorker(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareUploadWorker(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareDeleteWorker(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { scriptName } = args;
...
async function cloudflareListWorkerRoutes(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { zoneId } = args;
...
async function cloudflareCreateWorkerRoute(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareUpdateWorkerRoute(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareDeleteWorkerRoute(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { routeId } = args;
...
async function cloudflareListWorkerCronTriggers(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { scriptName } = args;
...
async function cloudflareCreateWorkerCronTrigger(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareDeleteWorkerCronTrigger(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { scriptName, cron } = args;
...
async function cloudflareGetWorkerSettings(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { scriptName } = args;
...
async function cloudflareUpdateWorkerSettings(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareListWorkerSubdomain(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareCreateWorkerSubdomain(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareGetWorkerTail(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { scriptName } = args;
...
async function cloudflareListWorkerSecrets(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
        const { scriptName } = args;
...
async function cloudflareCreateWorkerSecret(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
...
async function cloudflareDeleteWorkerSecret(args) {
    if (!this.cloudflareClient)
        throw new Error('Cloudflare client not initialized');
    try {
