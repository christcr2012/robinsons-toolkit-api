 ...
 */
function getAvailableProviders(): Set {
...
function scoreModelForTask(
  ...
  // Complexity match
  if (task.complexity === 'simple' && model.qualityScore  90) {
 ...
 */
export function detectTaskType(fileExtensions): TaskType {
 ...
 */
export function estimateComplexity(fileCount, avgFileSize): TaskComplexity {
  if (fileCount  b.qualityScore - a.qualityScore);
}
