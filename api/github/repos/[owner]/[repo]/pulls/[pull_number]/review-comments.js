 ...
 * GET /api/github/repos/[owner]/[repo]/pulls/[pull_number]/review-comments - List review comments
 */
...
module.exports = async (req, res) => {
  ...
  try {
    if (method === 'GET') {
      const { sort = 'created', direction = 'asc', per_page = 10, page = 1 } = query;
      const url = `https://api.github.com/repos/${owner}/${repo}/pulls/${pull_number}/comments?sort=${sort}&direction=${direction}&per_page=${per_page}&page=${page}`;
