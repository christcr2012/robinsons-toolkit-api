...
export async function context7SearchLibraries(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
...
export async function context7ListLibraries(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
...
export async function context7SearchDocs(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
...
export async function context7GetApiReference(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
        const { library, version } = args;
...
export async function context7GetGuides(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
        const { library, version } = args;
...
// ============================================================
export async function context7CompareVersions(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
...
export async function context7GetMigrationGuide(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
        const { library, from, to } = args;
...
export async function context7ListVersions(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
        const { library } = args;
...
// EXAMPLES - 2 handlers
// ============================================================
export async function context7GetExamples(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
...
export async function context7SearchExamples(args) {
    if (!this.context7Client)
        throw new Error('Context7 client not initialized');
    try {
