...
export abstract class BaseProvider {
   ...
   */
  protected calculateCost(model: ModelInfo, tokensInput, tokensOutput){
    if (!model.pricing) {
...
export class ProviderRegistry {
  ...
  private modelCache: Map = new Map();
  private lastDiscovery= 0;
  private discoveryInterval= 300000; // 5 minutes
